...
class AutenticaoApi(object):
    ...
    def post_autenticar(self, body, **kwargs):  # noqa: E501
        ...
        Obter o token de autenticacao para utilizacao da API.  O usuário e senha devem ser os mesmos utilizados para se autenticar no SINTEGRE, mas para obter acesso aos dados da API, a permissão deve ser solicitada em: https://sintegre.ons.org.br/paginas/meu-perfil/meus-sistemas.aspx   Processo: Operação Hidráulica  Sistema: IntegracaoHidrologia - API que fornece dados hidrológicos  O acesso será concedido após a aprovação do gestor do processo.  # noqa: E501
        ...
        :param Autenticacao body: (required)
    ...
    def post_renovar(self, body, **kwargs):  # noqa: E501
        ...
        Renovar o token de autenticacao para utilizacao da API  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool
        :param RenovarAutenticaco body: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
