...
class EmpresaResponse(object):
    ...
    def __init__(self, empresas=None, inicio_processamento=None, termino_processamento=None):  # noqa: E501
        """EmpresaResponse - a model defined in Swagger"""  # noqa: E501
        self._empresas = None
    ...
    @property
    def empresas(self):
        """Gets the empresas of this EmpresaResponse.  # noqa: E501

        Dados de Empresas  # noqa: E501

        :return: The empresas of this EmpresaResponse.  # noqa: E501
        :rtype: list[Empresa]
        """
    ...
    def empresas(self, empresas):
        """Sets the empresas of this EmpresaResponse.

        Dados de Empresas  # noqa: E501

        :param empresas: The empresas of this EmpresaResponse.  # noqa: E501
        :type: list[Empresa]
        """
        if empresas is None:
            raise ValueError("Invalid value for `empresas`, must not be `None`")  # noqa: E501

        self._empresas = empresas

    @property
    def inicio_processamento(self):
        """Gets the inicio_processamento of this EmpresaResponse.  # noqa: E501

        Momento em que iniciou o processamento de uma requisição.  # noqa: E501

        :return: The inicio_processamento of this EmpresaResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def inicio_processamento(self, inicio_processamento):
        """Sets the inicio_processamento of this EmpresaResponse.

        Momento em que iniciou o processamento de uma requisição.  # noqa: E501

        :param inicio_processamento: The inicio_processamento of this EmpresaResponse.  # noqa: E501
        :type: datetime
        """
    ...
    def termino_processamento(self):
        """Gets the termino_processamento of this EmpresaResponse.  # noqa: E501

        Momento de término de processamento de uma requisição.  # noqa: E501

        :return: The termino_processamento of this EmpresaResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def termino_processamento(self, termino_processamento):
        """Sets the termino_processamento of this EmpresaResponse.

        Momento de término de processamento de uma requisição.  # noqa: E501

        :param termino_processamento: The termino_processamento of this EmpresaResponse.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EmpresaResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EmpresaResponse):
            return False
