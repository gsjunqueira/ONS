...
class BalancoIntercambioLiquidoResponse(object):
    ...
    """
    swagger_types = {
        'balanco': 'AllOfBalancoIntercambioLiquidoResponseBalanco',
    ...
    def __init__(self, balanco=None, inicio_processamento=None, termino_processamento=None):  # noqa: E501
        """BalancoIntercambioLiquidoResponse - a model defined in Swagger"""  # noqa: E501
        self._balanco = None
    ...
    @property
    def balanco(self):
        """Gets the balanco of this BalancoIntercambioLiquidoResponse.  # noqa: E501

        Balanços programados por Região  # noqa: E501

        :return: The balanco of this BalancoIntercambioLiquidoResponse.  # noqa: E501
        :rtype: AllOfBalancoIntercambioLiquidoResponseBalanco
        """
        return self._balanco

    @balanco.setter
    def balanco(self, balanco):
        """Sets the balanco of this BalancoIntercambioLiquidoResponse.

        Balanços programados por Região  # noqa: E501

        :param balanco: The balanco of this BalancoIntercambioLiquidoResponse.  # noqa: E501
        :type: AllOfBalancoIntercambioLiquidoResponseBalanco
        """
    ...
    def inicio_processamento(self):
        """Gets the inicio_processamento of this BalancoIntercambioLiquidoResponse.  # noqa: E501

        Momento em que iniciou o processamento de uma requisição.  # noqa: E501

        :return: The inicio_processamento of this BalancoIntercambioLiquidoResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def inicio_processamento(self, inicio_processamento):
        """Sets the inicio_processamento of this BalancoIntercambioLiquidoResponse.

        Momento em que iniciou o processamento de uma requisição.  # noqa: E501

        :param inicio_processamento: The inicio_processamento of this BalancoIntercambioLiquidoResponse.  # noqa: E501
        :type: datetime
        """
    ...
    def termino_processamento(self):
        """Gets the termino_processamento of this BalancoIntercambioLiquidoResponse.  # noqa: E501

        Momento de término de processamento de uma requisição.  # noqa: E501

        :return: The termino_processamento of this BalancoIntercambioLiquidoResponse.  # noqa: E501
        :rtype: datetime
        """
    ...
    def termino_processamento(self, termino_processamento):
        """Sets the termino_processamento of this BalancoIntercambioLiquidoResponse.

        Momento de término de processamento de uma requisição.  # noqa: E501

        :param termino_processamento: The termino_processamento of this BalancoIntercambioLiquidoResponse.  # noqa: E501
        :type: datetime
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BalancoIntercambioLiquidoResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BalancoIntercambioLiquidoResponse):
            return False
